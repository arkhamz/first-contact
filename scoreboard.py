...
class Scoreboard():
	...
	def prep_high_score(self):
		...
		self.high_score_image = self.font.render(high_score_string,
			True,self.text_colour, self.game_settings.bg_colour)
			
		#get a rect of the high schore image and center it at the top 
		#of the screen 
